...
impl BitrateManager {
    ...
    pub fn get_encoder_params(&mut self, config: &BitrateConfig) -> FfiDynamicEncoderParams {
        ...
        let mut framerate = if config.adapt_to_framerate.enabled() {
            1.0 / self
        ...
        FfiDynamicEncoderParams {
            ...
            framerate,
            normalized_value:nol as f32,
            target_packetSize:tps as f32,
